...
//   final String uid;
//   const FriendScreen({super.key, required this.uid});
...
//                         left: width * 0.05,
//                         child: CircleAvatar(
//                           backgroundColor: Color.fromARGB(255, 252, 127, 3),
//                           radius: width * 0.19,
//                           child: image == null
//                               ? CircleAvatar(
//                                   backgroundImage:
...
//                             userData['name'],
//                             style: TextStyle(
//                                 fontSize: width * 0.047, color: Colors.white),
//                           )),
//                       Positioned(
//                           top: height * 0.29,
//                           right: width * 0.18,
...
//                             userData['bio'],
//                             style: TextStyle(
//                                 fontSize: width * 0.041, color: Colors.black),
//                           )),
//                       Positioned(
//                         top: height * 0.1,
//                         child: Row(
